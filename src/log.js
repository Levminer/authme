...
module.exports = logger = {
	log: (_message, _log) => {
		...
		console.log(`${_colors.green}[AUTHME LOG] ${_colors.blue}{${_time()}} ${_colors.white}${message} ${_colors.green}(${log}) ${_colors.white}`)
	...
	error: (_message, _error) => {
		...
		console.log(`${_colors.red}[AUTHME ERROR] ${_colors.blue}{${_time()}} ${_colors.white}${message} ${_colors.red}(${error}) ${_colors.white}`)
