...
<script>
	import { aegisFile, bitwardenFile, captureScreen, chooseFile, chooseImages, manualEntry, showManualEntry, showTutorial, twoFasAuthFile, useWebcam, protonFile } from "./index"
