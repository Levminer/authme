...
_MIGRATIONPAYLOAD_OTPPARAMETERS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="secret",
            full_name="MigrationPayload.OtpParameters.secret",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="name",
            full_name="MigrationPayload.OtpParameters.name",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="issuer",
            full_name="MigrationPayload.OtpParameters.issuer",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="algorithm",
            full_name="MigrationPayload.OtpParameters.algorithm",
            index=3,
            number=4,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="digits",
            full_name="MigrationPayload.OtpParameters.digits",
            index=4,
            number=5,
            type=5,
            cpp_type=1,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="MigrationPayload.OtpParameters.type",
            index=5,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="counter",
            full_name="MigrationPayload.OtpParameters.counter",
            index=6,
            number=7,
            type=3,
            cpp_type=2,
...
_MIGRATIONPAYLOAD_OTPPARAMETERS.fields_by_name[
    "algorithm"
].enum_type = _MIGRATIONPAYLOAD_ALGORITHM
_MIGRATIONPAYLOAD_OTPPARAMETERS.fields_by_name[
    "type"
].enum_type = _MIGRATIONPAYLOAD_OTPTYPE
_MIGRATIONPAYLOAD_OTPPARAMETERS.containing_type = _MIGRATIONPAYLOAD
_MIGRATIONPAYLOAD.fields_by_name[
    "otp_parameters"
].message_type = _MIGRATIONPAYLOAD_OTPPARAMETERS
