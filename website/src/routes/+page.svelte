	...
	const api = async () => {
		...
		if (os !== undefined) {
			...
			if (os.includes("Mac OS")) {
				...
				download_text.textContent = "(macOS x64)"
			}
		}
	}
...
<section id="downloads" class="text-gray-400 body-font">
	<div class="container px-5 py-24 mx-auto">
				...
				<div class="p-2 w-full">
					...
					>
						<div class="flex flex-row gap-1">
							...
							<span class="title-font font-medium text-white">
								<h1 class="text-2xl">macOS Installer x64 (.dmg)</h1>
							</span>
						</div>
		...
		<!-- ALPHA -->
		<div class="bg-gray-900 rounded-2xl pt-10 pb-10 small:w-11/12 mx-auto small:p-3 mt-20">
			<h1 id="downloads-alpha" class="text-4xl font-medium text-center title-font text-white mb-4">
				Latest alpha
			</h1>
				...
				<div class="p-2 w-full">
					...
					>
						<div class="flex flex-row gap-1 text-white">
							...
							<span class="title-font font-medium text-white">
								<h1 class="text-2xl">Windows Installer and Portable x64 (.zip)</h1>
							</span>
						</div>

						<span class="title-font font-medium text-white">
							<a class="button m-3" href="https://api.levminer.com/api/v1/authme/alpha/windows">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="h-6 w-6"
									fill="none"
				...
				<div class="p-2 w-full">
					...
					>
						<div class="flex flex-row gap-1">
							...
							<span class="title-font font-medium text-white">
								<h1 class="text-2xl">Linux Installer and Portable x64 (.zip)</h1>
							</span>
						</div>

						<span class="title-font font-medium text-white">
							<a class="button m-3" href="https://api.levminer.com/api/v1/authme/alpha/linux">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="h-6 w-6"
									fill="none"
				...
				<div class="p-2 w-full">
					...
					>
						<div class="flex flex-row gap-1">
							...
							<span class="title-font font-medium text-white">
								<h1 class="text-2xl">macOS Installer and Portable x64 (.zip)</h1>
							</span>
						</div>

						<span class="title-font font-medium text-white">
							<a class="button m-3" href="https://api.levminer.com/api/v1/authme/alpha/mac">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									class="h-6 w-6"
									fill="none"
